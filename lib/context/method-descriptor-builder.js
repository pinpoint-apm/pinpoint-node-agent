...
class MethodDescriptorBuilder {
    ...
    updateProperties() {
        if (this.moduleName && !this.objectPath) {
            this.apiDescriptor = `${this.getModuleName()}.<anonymous>`
            this.fullName = `${this.getModuleName()}.<anonymous>`
            return
        }
        ...
        if (this.moduleName && !this.fullName) {
            this.fullName = `${this.getModuleName()}.${this.apiDescriptor}`
        } else {
            this.fullName = `${this.apiDescriptor}`
        }
    }
