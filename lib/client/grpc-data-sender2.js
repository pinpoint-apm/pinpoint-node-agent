...
const agentInformationMetadataInterceptor = require('./grpc/agent-information-metadata-interceptor')
...
class GrpcDataSender {
  ...
  initializeClients(collectorIp, collectorTcpPort) {
    this.agentClient = new services.AgentClient(
      ...
      interceptors: [agentInformationMetadataInterceptor(this.agentInfo), function (options, nextCall) {
    ...
    this.metadataClient = new services.MetadataClient(collectorIp + ":" + collectorTcpPort, grpc.credentials.createInsecure(), { interceptors: [agentInformationMetadataInterceptor(this.agentInfo)] })
  ...
  initializeSpanStream(collectorIp, collectorSpanPort, config) {
    this.spanClient = new services.SpanClient(collectorIp + ":" + collectorSpanPort, grpc.credentials.createInsecure(), { interceptors: [agentInformationMetadataInterceptor(this.agentInfo)] })
  ...
  initializeStatStream(collectorIp, collectorStatPort, config) {
    this.statClient = new services.StatClient(collectorIp + ":" + collectorStatPort, grpc.credentials.createInsecure(), { interceptors: [agentInformationMetadataInterceptor(this.agentInfo)] })
