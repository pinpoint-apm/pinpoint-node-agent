...
module.exports = function (agent, version, express) {
  ...
  function cacheMethodDescriptor(stacks) {
    ...
    const builder = new MethodDescriptorBuilder(MODULE_NAME, 'route', groups.groups.method)
    apiMetaService.cacheAPIMeta(builder)
