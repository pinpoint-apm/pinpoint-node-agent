...
class AgentBuilder {
    ...
    setParsingResultFactory(parsingResultFactory) {
        this.parsingResultFactory = parsingResultFactory
        return this
    }
    ...
    build() {
        ...
        const parsingResultFactory = this.parsingResultFactory ?? new IntIdParsingResultFactory()
