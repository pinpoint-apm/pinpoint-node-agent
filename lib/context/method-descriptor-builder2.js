...
class MethodDescriptorBuilder2 {
    ...
    static makeRuntimeDetectionMethodDescriptorBuilder() {
        return new MethodDescriptorBuilder2().enableRuntimeDetection(true)
    }
    ...
    makeCloneOf(functionName) {
        let clone
        if (functionName) {
            clone = new MethodDescriptorBuilder2(functionName)
        } else {
            clone = new MethodDescriptorBuilder2(this.functionName)
        }
