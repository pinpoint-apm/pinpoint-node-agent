...
module.exports = function(agent, version, https) {
  ...
  shimmer.wrap(https && https.Server && https.Server.prototype, 'emit', httpShared.instrumentRequest2(agent, 'https'))
  ...
  if (semver.gte(version, '9.0.0')) {
    ...
    shimmer.wrap(https, 'request', httpShared.traceOutgoingRequest2(agent, 'https'))
  }
