...
const TAgentStat = require('./thrift/Pinpoint_types').TAgentStat
const TCmdActiveThreadCountRes = require('./thrift/Command_types').TCmdActiveThreadCountRes
const TAgentInfo = require('./thrift/Pinpoint_types').TAgentInfo
const TStringMetaData = require('./thrift/Trace_types').TStringMetaData
const TApiMetaData = require('./thrift/Trace_types').TApiMetaData
const TSpan = require('./thrift/Trace_types').TSpan
const TSpanChunk = require('./thrift/Trace_types').TSpanChunk
...
const createTActiveTraceCountRes = (activeTrace) => {
  if (!activeTrace) return
  return new TCmdActiveThreadCountRes({
    histogramSchemaType: activeTrace.typeCode,
    activeThreadCount: [
      activeTrace.fastCount,
      activeTrace.normalCount,
      activeTrace.slowCount,
      activeTrace.verySlowCount,
    ],
    timeStamp: Date.now()
  })
}
