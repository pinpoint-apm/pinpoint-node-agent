...
'use strict';
var TransactionId = require('context/transaction-id');
var BytesUtils = require('./bytes-utils');
var VERSION_STRING = 0;
var TRANSACTION_ID_DELIMITER_STRING = '^'
var NULL = -1;
...
var TransactionIdUtil = {
    ...
    formatBytes : function (transactionId) {
        ...
        var transactionSequence = transactionId.sequence;
