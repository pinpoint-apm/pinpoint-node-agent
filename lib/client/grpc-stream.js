...
class GrpcStream {
    constructor(client, newStream) {
        this.newStream = newStream
        this.client = client

        if (client.constructor && client.constructor.name) {
            this.name = client.constructor && client.constructor.name 
        } else {
            this.name = "undefined name stream"
        }
