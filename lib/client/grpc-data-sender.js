  ...
  constructor(
    ...
    this.agentClient = new services.AgentClient(
      ...
      grpc.credentials.createInsecure(), {
        interceptors: [headerInterceptor, new grpc.InterceptingCall(nextCall(options), {
          start: function (metadata, listener, next) {
    ...
    call.on('data', function (data) {
      log.debug(`sendPing on(data) : ${JSON.stringify(data.toObject())}`)
    })
