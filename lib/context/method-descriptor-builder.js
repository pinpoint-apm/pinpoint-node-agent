...
class MethodDescriptorBuilder {
    constructor(moduleName, objectPath, methodName) {
        ...
        this.apiId = 0
        this.computedApiDescriptor = this.makeApiDescriptor(moduleName, objectPath)
    ...
    build() {
        ...
        return new MethodDescriptor(this.moduleName, this.objectPath, this.methodName, this.type, apiDescriptor, this.apiId, fullName, this.className, this.lineNumber, this.fileName)
    }
    ...
    setParameterDescriptor(parameterDescriptor) {
        ...
        this.computedApiDescriptor = this.makeApiDescriptor(this.moduleName, this.objectPath)
