...
class Agent {
  constructor (initOptions) {
    ...
    this.agentInfo = AgentInfo.create(this.config, this.agentStartTime)
    ...
    stringMetaService.init(this.agentInfo, this.dataSender)
    apiMetaService.init(this.agentInfo, this.dataSender)
