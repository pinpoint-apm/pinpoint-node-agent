...
class UriStatsConfig {
    ...
    isUriStatsExplicitlyEnabled() {
        return this.enabled === true
    }

    isUriStatsExplicitlyDisabled() {
    ...
    isUriStatsEnabled() {
        if (this.isUriStatsExplicitlyDisabled()) {
            return false
        }

        if (this.isUriStatsExplicitlyEnabled()) {
            return true
        }
...
class UriStatsConfigBuilder {
    ...
    build() {
        ...
        if (mergedUriStats.enabled === false) {
            return new UriStatsConfig({ enabled: false })
        }
