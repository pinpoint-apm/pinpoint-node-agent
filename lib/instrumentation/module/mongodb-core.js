...
module.exports = function(agent, version, mongodb) {
  ...
  function wrappedCallbackk (trace, asyncEventRecorder, cb) { return function tt() {
    ...
    return function () {
      ...
      if (trace && arguments.length > 0) {
        ...
        if (typeof cb === 'function') {
          ...
          if (trace) {
            // console.log('test1->\n', typeof arguments[0])
            // console.log('test2->\n', typeof wrappedCallbackk(trace, asyncEventRecorder, cb))
            // console.log('test3->\n', typeof test)
            // const test1 = wrappedCallbackk(trace, asyncEventRecorder, cb)
            // console.log('test4->\n', typeof test1)
            // console.log('test3->\n', typeof testArg('1'))

            arguments[0] = wrappedCallbackk(trace, asyncEventRecorder, cb)
