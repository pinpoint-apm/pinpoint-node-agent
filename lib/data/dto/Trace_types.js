...
var TLocalAsyncId = module.exports.TLocalAsyncId = function(args) {
  this.asyncId = null;
  this.sequence = null;
  if (args) {
...
TLocalAsyncId.prototype = {};
TLocalAsyncId.prototype.read = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
...
TLocalAsyncId.prototype.write = function(output) {
  output.writeStructBegin('TLocalAsyncId');
  if (this.asyncId !== null && this.asyncId !== undefined) {
    output.writeFieldBegin('asyncId', Thrift.Type.I32, 1);
    output.writeI32(this.asyncId);
    output.writeFieldEnd();
  }
  if (this.sequence !== null && this.sequence !== undefined) {
    output.writeFieldBegin('sequence', Thrift.Type.I32, 2);
    output.writeI32(this.sequence);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
  output.writeStructEnd();
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i2 = 0; _i2 < _size0; ++_i2) {
          var elem3 = null;
          elem3 = new ttypes.TAnnotation();
          elem3.read(input);
          this.annotations.push(elem3);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TSpanEvent.prototype.write = function(output) {
  ...
  if (this.annotations !== null && this.annotations !== undefined) {
    ...
    for (var iter4 in this.annotations) {
      if (this.annotations.hasOwnProperty(iter4)) {
        iter4 = this.annotations[iter4];
        iter4.write(output);
      }
    }
    output.writeListEnd();
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i11 = 0; _i11 < _size9; ++_i11) {
          var elem12 = null;
          elem12 = new ttypes.TSpanEvent();
          elem12.read(input);
          this.spanEventList.push(elem12);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TSpan.prototype.write = function(output) {
  ...
  if (this.annotations !== null && this.annotations !== undefined) {
    ...
    output.writeListBegin(Thrift.Type.STRUCT, this.annotations.length);
    for (var iter13 in this.annotations) {
      if (this.annotations.hasOwnProperty(iter13)) {
        iter13 = this.annotations[iter13];
        iter13.write(output);
      }
    }
    output.writeListEnd();
  ...
  if (this.spanEventList !== null && this.spanEventList !== undefined) {
    ...
    for (var iter14 in this.spanEventList) {
      if (this.spanEventList.hasOwnProperty(iter14)) {
        iter14 = this.spanEventList[iter14];
        iter14.write(output);
      }
    }
    output.writeListEnd();
...
var TSpanChunk = module.exports.TSpanChunk = function(args) {
  ...
  if (args) {
    ...
    if (args.localAsyncId !== undefined && args.localAsyncId !== null) {
      this.localAsyncId = new ttypes.TLocalAsyncId(args.localAsyncId);
    }
  }
};
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i17 = 0; _i17 < _size15; ++_i17) {
          var elem18 = null;
          elem18 = new ttypes.TSpanEvent();
          elem18.read(input);
          this.spanEventList.push(elem18);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      case 14:
      if (ftype == Thrift.Type.STRUCT) {
        this.localAsyncId = new ttypes.TLocalAsyncId();
        this.localAsyncId.read(input);
      } else {
        input.skip(ftype);
      }
      break;
...
TSpanChunk.prototype.write = function(output) {
  ...
  if (this.spanEventList !== null && this.spanEventList !== undefined) {
    ...
    output.writeListBegin(Thrift.Type.STRUCT, this.spanEventList.length);
    for (var iter19 in this.spanEventList) {
      if (this.spanEventList.hasOwnProperty(iter19)) {
        iter19 = this.spanEventList[iter19];
        iter19.write(output);
      }
    }
    output.writeListEnd();
  ...
  if (this.localAsyncId !== null && this.localAsyncId !== undefined) {
    output.writeFieldBegin('localAsyncId', Thrift.Type.STRUCT, 14);
    this.localAsyncId.write(output);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
  output.writeStructEnd();
