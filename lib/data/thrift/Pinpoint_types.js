    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i11 = 0; _i11 < _size9; ++_i11) {
          var elem12 = null;
          elem12 = new ttypes.TServiceInfo();
          elem12.read(input);
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i22 = 0; _i22 < _size20; ++_i22) {
          var elem23 = null;
          elem23 = new Command_ttypes.TThreadDump();
          elem23.read(input);
          this.deadlockedThreadList.push(elem23);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TDeadlock.prototype.write = function(output) {
  ...
  if (this.deadlockedThreadList !== null && this.deadlockedThreadList !== undefined) {
    ...
    for (var iter24 in this.deadlockedThreadList) {
      if (this.deadlockedThreadList.hasOwnProperty(iter24)) {
        iter24 = this.deadlockedThreadList[iter24];
        iter24.write(output);
      }
    }
    output.writeListEnd();
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i27 = 0; _i27 < _size25; ++_i27) {
          var elem28 = null;
          elem28 = new ttypes.TAgentStat();
          elem28.read(input);
          this.agentStats.push(elem28);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TAgentStatBatch.prototype.write = function(output) {
  ...
  if (this.agentStats !== null && this.agentStats !== undefined) {
    ...
    for (var iter29 in this.agentStats) {
      if (this.agentStats.hasOwnProperty(iter29)) {
        iter29 = this.agentStats[iter29];
        iter29.write(output);
      }
    }
    output.writeListEnd();
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i32 = 0; _i32 < _size30; ++_i32) {
          var elem33 = null;
          elem33 = new ttypes.TDataSource();
          elem33.read(input);
          this.dataSourceList.push(elem33);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TDataSourceList.prototype.write = function(output) {
  ...
  if (this.dataSourceList !== null && this.dataSourceList !== undefined) {
    ...
    for (var iter34 in this.dataSourceList) {
      if (this.dataSourceList.hasOwnProperty(iter34)) {
        iter34 = this.dataSourceList[iter34];
        iter34.write(output);
      }
    }
    output.writeListEnd();
