...
class RequestHeaderUtils {
  ...
  static readPinpointHeader (request, requestData) {
    ...
    if (requestData.transactionId) {
      requestData.spanId = new Int64(this.getHeader(request, PinpointHeader.HTTP_SPAN_ID))
      requestData.parentSpanId = new Int64(this.getHeader(request, PinpointHeader.HTTP_PARENT_SPAN_ID))
