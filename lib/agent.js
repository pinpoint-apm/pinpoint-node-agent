...
class Agent {
  constructor (initOptions) {
    ...
    if (this.config.disabled === true || this.config.disabled === 'true') {
      log.warn('[Pinpoint Agent] Disabled')
      return
    }

    log.warn('[Pinpoint Agent] Init Started')
    ...
    log.warn('[Pinpoint Agent] Init Finished')
  }
