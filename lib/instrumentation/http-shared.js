...
exports.instrumentRequest2 = function (agent) {
  return function (original) {
    return function (event, req, res) {
      ...
      const requestTrace = new HttpRequestTraceBuilder(agent.traceContext, req).build()
...
exports.traceOutgoingRequest2 = function (agent, moduleName) {
  return function (original) {
    return function () {
      const req = original.apply(this, arguments)

      const requestHeader = new HttpOutgoingRequestHeader(agent.traceContext, req)
      requestHeader.writePinpointHeader()
