...
const CONFIG_FILE_MAP = {
  ...
  grpcCollectorIp: 'grpc.collector.ip',
  grpcCollectorTcpPort: 'grpc.collector.tcp-port',
  grpcCollectorStatPort: 'grpc.collector.stat-port',
  grpcCollectorSpanPort: 'grpc.collector.span-port',
}
