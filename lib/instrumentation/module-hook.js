    ...
    start() {
        for (const module of modules) {
            ...
            if (module.hook) {
                ...
                if (!requireId) {
                    throw new Error(`Invalid module configuration: ${module}`)
                }
        ...
        this.requireHook = new Hook(this.hookRegistry.requireModules(), { internals: true }, (exports, requireId, basedir) => {
