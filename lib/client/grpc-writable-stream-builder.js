...
class GrpcWritableStream {
    ...
    get ended() {
        if (typeof this.writableAndEnded?.ended === 'function') {
            return this.writableAndEnded.ended(this.writableStream)
        }
    ...
    availableRetry() {
        // TODO: If only avaiableRetry() be true, and then writable checked, it will be true.
        // return this.backoffRetry.availableRetry() || !this.writable
