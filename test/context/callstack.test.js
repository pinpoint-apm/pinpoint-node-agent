...
test(`fix express call stack depth`, async (t) => {
    ...
    const server = app.listen(TEST_ENV.port, async function () {
        ...
        let actualBuilder = new MethodDescriptorBuilder('express', 'use')
        .setParameterDescriptor('(jsonParser)')
        .setLineNumber(51)
        ...
        t.equal(actualMethodDescriptor.fullName, 'express.use(jsonParser)', 'use(jsonParser) fullName')
        ...
        .setParameterDescriptor('(urlencodedParser)')
        .setLineNumber(52)
        .setFileName('callstack.test.js')
        ...
        t.equal(actualMethodDescriptor.fullName, 'express.use(urlencodedParser)', 'use(urlencodedParser) fullName')
