...
class Trace {
  ...
  traceBlockBegin () {
    console.log('let traceBlockBegin -> ', this.callStack.length , ' Date.now() ->' ,Date.now())
  ...
  traceBlockEnd (spanEventRecorder) {
    console.log('let traceBlockEnd -> ', this.callStack.length , ' Date.now() ->' ,Date.now())
